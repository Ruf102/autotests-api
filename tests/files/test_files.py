...
class TestFiles:
    ...
    def test_create_file_with_empty_filename(self, files_client: FilesClient):
        ...
        response = files_client.create_file_api(request)
        response_date = ValidationErrorResponseSchema.model_validate_json(response.text)

        assert_status_code(response.status_code, HTTPStatus.UNPROCESSABLE_CONTENT)

        assert_create_file_with_empty_filename_response(response_date)
    ...
    def test_create_file_with_empty_directory(self, files_client: FilesClient):
        ...
        assert_create_file_with_empty_directory_response(response_date)
    ...
    def test_delete_file(self, files_client: FilesClient, function_file: FileFixture):
        ...
        get_response = files_client.get_files_api(function_file.response.file.id)
